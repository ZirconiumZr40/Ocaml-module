...
let contact () = print_string
  "You can contact me on
  \t Contact us on twitter : https://twitter.com/zirconium_60
  \t See what's new on github : https://github.com/ZirconiumZr40/Ocaml-module"
